...
<table class="bbs_default view"> 
	...
	<tbody>
		...
		<tr>
			<th scope="row">상호</th>
			<td colspan="3">(주)The Glasses</td>
		</tr>								
		<tr>
			<th scope="row">대표자명</th>
			
			
			<td>박종두,이주환,하승원,김승헌,김태한</td>
		...
		<tr>
			...
			<td colspan="3">
				...
				서울시 서대문구 신촌로119 신영스카이텔 3층 304호
			</td>
		</tr>								
		<tr>
		...
		<tr>
			...
			<td colspan="3">서울시 서대문구 신촌로119 신영스카이텔 3층 304호</td>
		</tr>
		<tr>
			<th scope="row">통신판매업 신고기관명</th>
			
			<td colspan="3">서울특별시 마포구청&nbsp;&nbsp;(00-0000-0000,0000)</td>
		</tr>
	</tbody>
</table>
<div class="box type4">
