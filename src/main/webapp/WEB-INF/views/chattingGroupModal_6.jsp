...
<div class="modal fade" id="chattingGroupModal_6" tabindex="-1" role="dialog"
				...
				<ul class="nav nav-tabs md-tabs tabs-2 light-blue darken-3"
					...
					<li class="nav-item"><a class="nav-link active"
						data-toggle="tab" href="#panel7" role="tab"><i
							class="fas fa-user mr-1"></i>관심사 6 그룹채팅</a></li>
					<%--
					<li class="nav-item"><a class="nav-link active"
						data-toggle="tab" href="#panel7" role="tab"><i
...
<script type="text/javascript">
	...
	function sockGroupConnect() {
		...
		wsocket_Group = 
			new WebSocket("ws://localhost:8080/webapp/chat_group_6");
