...
<body>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-10">
							...
							<tr>
								<c:forEach items="${ members }" var="result" varStatus="status">
									<tr>
										...
										<td style="vertical-align: middle;">${ result.getAuthString() }</td>
					...
					<button class="btn btn-primary" type="button" id="checked_member_delete">선택 회원 삭제</button>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$("#checked_member_delete").on("click", function() {
